...
A vantagem de construir a classe venda como abstrata tendo o método getTotal()
como abstrato é a facilidade de fazer a herança de diversas sub classes de venda
implementando de diversas maneiras este metodo. Pois cada venda tem um tipo de 
pagamento.
*/
                ...
                case 1:
                    ...
                    switch (opcao2) {
                        case 1:
                            ...
                            vv.adicionaPedido(terceiroPedido);
                            v.add(vv);
                            break;
                        case 2:
                            vp.adicionaPedido(primeiroPedido);
                            vp.adicionaPedido(terceiroPedido);
                            v.add(vp);
                            break;
                        default:
